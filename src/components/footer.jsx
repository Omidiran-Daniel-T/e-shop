    ...
    <section className="px-2 border-t-2">
      <section className="py-10 px-5 max-w-sm m-auto md:flex md:max-w-full justify-evenly md:px-10">
        <div className="mb-10 md:max-w-xs">
          <div className="text-4xl text-gray-400 font-bold">SOLD</div>
      ...
      <section className="border-t-2 text-gray-500 flex bg-red-00 justify-center py-5 px-10">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
        ...
        2021 Ecommerce Homepage made by Daniel Omidiran
      </section>
    </section>
  );
};
